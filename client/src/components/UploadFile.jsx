...
export default function UploadFile({ contract, account }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <form
        ...
        className=" border-dashed border-white border-2 hover:border-cyan-500 h-60 w-80  flex justify-center items-center cursor-pointer rounded-xl"
        {...getRootProps()}
      >
        <input {...getInputProps()} />
        {isDragActive ? (
